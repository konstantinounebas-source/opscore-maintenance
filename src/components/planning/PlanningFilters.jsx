  ...
  return (
    <div className="bg-white border border-slate-200 rounded-lg p-4 space-y-3">
      ...
      <div className="flex gap-2 pt-1">
        <Button size="sm" className="flex-1 bg-indigo-600 hover:bg-indigo-700 text-xs h-8" onClick={onApply}>
          Apply Filters
        </Button>
        <Button size="sm" variant="outline" className="text-xs h-8 gap-1" onClick={onReset}>
