...
const defaultData = {
  ...
  structural_na: false, structural_frame_check: false, structural_frame_status: "",
  structural_connections_check: false, structural_connections_status: "",
  structural_paint_check: false, structural_paint_status: "", structural_notes: "",
  panels_na: false, panels_side_check: false, panels_side_status: "",
  panels_plastic_check: false, panels_plastic_status: "",
  panels_sealing_check: false, panels_sealing_status: "", panels_notes: "",
  glass_na: false, glass_surface_check: false, glass_surface_status: "",
  glass_frames_check: false, glass_frames_status: "", glass_notes: "",
  bench_na: false, bench_wood_check: false, bench_wood_status: "",
  bench_supports_check: false, bench_supports_status: "", bench_notes: "",
  elec_infra_na: false, elec_power_panel_check: false, elec_power_panel_status: "",
  elec_wiring_check: false, elec_wiring_status: "",
  elec_screen_check: false, elec_screen_status: "", elec_infra_notes: "",
  solar_na: false, solar_panel_check: false, solar_panel_status: "",
  solar_indicator_check: false, solar_indicator_status: "", solar_notes: "",
  energy_na: false, energy_battery_check: false, energy_battery_status: "",
  energy_connections_check: false, energy_connections_status: "",
  energy_replacement_check: false, energy_replacement_status: "", energy_notes: "",
  elec_panel_na: false, elec_router_check: false, elec_router_status: "",
  elec_controller_check: false, elec_controller_status: "",
  elec_power_check: false, elec_power_status: "", elec_panel_notes: "",
  lighting_na: false, lighting_roof_check: false, lighting_roof_status: "",
  lighting_sign_check: false, lighting_sign_status: "", lighting_notes: "",
  software_na: false, software_lighting_check: false, software_lighting_status: "",
  software_normal_check: false, software_normal_status: "", software_notes: "",
  extra_equip_na: false, extra_malfunction_check: false, extra_malfunction_status: "",
  extra_bin_check: false, extra_bin_status: "",
  extra_signs_check: false, extra_signs_status: "", extra_equip_notes: "",
  roof_na: false, roof_lightbox_check: false, roof_lightbox_status: "",
  roof_panels_check: false, roof_panels_status: "", roof_notes: "",
...
export default function CorrectiveWOForm({ submission, incident, incidentId, workOrders, onClose }) {
  ...
  const handleSubmit = async () => {
    ...
    } catch (pdfErr) { console.warn("Corrective WO PDF auto-attach failed:", pdfErr?.message); }
