  ...
  const updateRow = (idx, patch) => {
    setRows(prev => prev.map((r, i) => {
      ...
      if (patch.catalog_id !== undefined) {
        // Support both ChildCatalog and FMPIContractCatalogue
        const childItem = catalogMap[patch.catalog_id];
        const fmpiItem = fmpiCatalogue.find(f => f.id === patch.catalog_id);
        if (fmpiItem) {
