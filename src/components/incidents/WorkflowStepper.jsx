...
export default function WorkflowStepper({ incident, hasFMPISubmitted, fmpiApprovalRequired, incidentWorkOrders }) {
  ...
  const steps = [
    ...
    {
      id: "ca_initiation_approval",
      label: "CA Initiation Approval",
      description: fmpiApprovalRequired ? "Pending CA Approval for Initiation" : "In Warranty — Not required",
      completed: !fmpiApprovalRequired || incident.ca_initiation_decision === "Approved" || incident.ca_decision === "Approved",
      timestamp: incident.ca_initiation_decision_at || incident.ca_decision_at,
      optional: !fmpiApprovalRequired,
      locked: false,
      rejected: incident.ca_initiation_decision === "Rejected",
    },
    {
      id: "works",
      label: "Works",
    ...
    {
      id: "ca_completion_approval",
      label: "CA Completion Approval",
      description: fmpiApprovalRequired ? "Pending CA Approval After Work Completion" : "In Warranty — Not required",
      completed: !fmpiApprovalRequired || incident.ca_completion_decision === "Approved",
      timestamp: incident.ca_completion_decision_at,
      optional: !fmpiApprovalRequired,
      locked: false,
      rejected: incident.ca_completion_decision === "Rejected",
    },
    {
      id: "closure",
      label: "Closure",
