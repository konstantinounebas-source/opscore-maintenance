...
const computeWarrantyDates = (deliveryYear) => {
  ...
  if (isNaN(y)) return {};
  const fmt = (yr, mo, dy) => new Date(yr, mo - 1, dy).toISOString().split("T")[0];
  return {
    ...
    preventive_inspection_date: fmt(2029, 1, 1),
    next_inspection_date: fmt(2029, 1, 1),
  };
};
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-2">
          ...
          {/* 4. Child Component Warranty Dates */}
          <div className="grid grid-cols-2 gap-4">
